        ...
        <div className="container">
          ...
          <div className="row mt-5 justify-content-between">
            ...
            <div className="col" style={{backgroundColor:"rgba(0,0,0,0.85)"}}>
              ...
              <p className="gsap-reveal"><a className="btn btn-outline-pill btn-custom-light" href="ressources/cv_master.pdf" download="cv_yassine_el_allali">Télécharger mon CV</a></p>
            </div>
          </div>
        </div>
      </div>
